...
static char const *s_szStatusLabels[]={
	...
	"Creating world...",
	"Saving the world...",	
	"Computing cave surfaces...",
	"Verifying physics...",
	"Computing visibility...",
	"Computing visibility...",
	"Computing visibility...",
	"Computing lighting...",
	"Building metaphysical light bulbs...",
	"Finalizing world lighting...",
	"Maintaining the ambience...",
	"Determining optimal prop lighting...",
};
#else
static char const *s_szStatusLabels[]={
	"Creating BSP...",
...
void CASW_Map_Builder::BuildMap()
{
	...
	else
	{
		...
		char buffer[512];
		Q_snprintf( buffer, sizeof(buffer), "-alldetail -game ..\\ %s %s", m_pMapBuilderOptions->GetString( "vbsp", "" ), vmfFilename );
