...
void CBaseModPanel::OnGameUIActivated()
{
	...
	{
		bool bForceReturnToFrontScreen = true;//false;
...
void CBaseModPanel::OnLevelLoadingStarted( char const *levelName, bool bShowProgressDialog )
{
	...
	if ( levelName )
		pChapterInfo->SetString( "map", levelName );
...
void CBaseModPanel::ApplySchemeSettings(IScheme *pScheme)
{
	...
	surface()->DrawSetTextureFile( m_iProductImageID, "console/startup_loading_jastiansummer", true, false );
