...
class C_JaS_Pickup_Weapon_Flashlight : public C_ASW_Pickup_Weapon
{
public:
	DECLARE_CLASS( C_JaS_Pickup_Weapon_Flashlight, C_ASW_Pickup_Weapon );
	DECLARE_CLIENTCLASS();

	virtual const char* GetWeaponClass() { return "jas_weapon_flashlight"; }
	C_JaS_Pickup_Weapon_Flashlight();
};
