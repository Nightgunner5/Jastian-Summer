...
public:
	...
	bool m_bBeingControlled;
	bool IsBeingControlled() { return m_bBeingControlled; }
	void SetBeingControlled( bool bBeingControlled );

	virtual bool ShouldSeeEntity( CBaseEntity *pEntity );
	virtual bool CanSeeEntity( CBaseEntity *pSightEnt );
