...
BEGIN_DATADESC( CASW_Sentry_Base )
	...
	DEFINE_KEYFIELD( m_fAssembleProgress, FIELD_FLOAT, "sentry_assembled" ),
	DEFINE_FIELD( m_fAssembleCompleteTime, FIELD_TIME ),
	DEFINE_FIELD( m_hDeployer, FIELD_EHANDLE ),
	DEFINE_KEYFIELD( m_nGunType, FIELD_INTEGER, "sentry_type" ),
END_DATADESC()
...
void CASW_Sentry_Base::Spawn( void )
{
	...
	// If the sentry is fully assembled on spawn, make the top half magically appear.
