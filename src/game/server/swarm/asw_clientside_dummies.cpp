...
class CASW_FirstPerson_Dummy : public CServerOnlyPointEntity
{
	DECLARE_CLASS( CASW_FirstPerson_Dummy, CServerOnlyPointEntity );
public:
	virtual void Spawn()
	{
		BaseClass::Spawn();
		...
		GlobalEntity_Add( "jas_firstperson", STRING( gpGlobals->mapname ), GLOBAL_ON );
	}
};
...
LINK_ENTITY_TO_CLASS( asw_firstperson, CASW_FirstPerson_Dummy );