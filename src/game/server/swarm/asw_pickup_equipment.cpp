...
//---------------------
// Flashlight (Jastian Summer)
//---------------------

IMPLEMENT_SERVERCLASS_ST(CJaS_Pickup_Weapon_Flashlight, DT_JaS_Pickup_Weapon_Flashlight)
END_SEND_TABLE()

BEGIN_DATADESC( CJaS_Pickup_Weapon_Flashlight )
END_DATADESC()

void CJaS_Pickup_Weapon_Flashlight::Spawn( void )
{ 
	Precache();
	SetModel( "models/swarm/flashlight/flashlightpickup.mdl" );
	BaseClass::Spawn();
...
void CJaS_Pickup_Weapon_Flashlight::Precache( void )
{
	PrecacheModel( "models/swarm/flashlight/flashlightpickup.mdl" );
}

LINK_ENTITY_TO_CLASS(jas_pickup_flashlight, CJaS_Pickup_Weapon_Flashlight);
PRECACHE_REGISTER(jas_pickup_flashlight);
