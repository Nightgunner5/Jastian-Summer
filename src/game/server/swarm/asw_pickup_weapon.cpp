...
BEGIN_DATADESC( CASW_Pickup_Weapon_Railgun )
	DEFINE_KEYFIELD( m_bSafetyEnabled, FIELD_BOOLEAN, "safety_enabled" ),
END_DATADESC()
...
void CASW_Pickup_Weapon_Railgun::InitFrom(CASW_Marine *pMarine, CASW_Weapon *pWeapon)
{
	BaseClass::InitFrom(pMarine, pWeapon);

	if ( dynamic_cast<CASW_Weapon_Railgun *>( pWeapon ) )
	{
		m_bSafetyEnabled = dynamic_cast<CASW_Weapon_Railgun *>( pWeapon )->m_bSafetyEnabled;
	}
}

void CASW_Pickup_Weapon_Railgun::InitWeapon(CASW_Marine *pMarine, CASW_Weapon *pWeapon)
{
	BaseClass::InitWeapon(pMarine, pWeapon);

	if ( dynamic_cast<CASW_Weapon_Railgun *>( pWeapon ) )
	{
		dynamic_cast<CASW_Weapon_Railgun *>( pWeapon )->m_bSafetyEnabled = m_bSafetyEnabled;
	}
}
