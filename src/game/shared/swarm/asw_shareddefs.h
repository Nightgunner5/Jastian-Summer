...
#define USE_MEDAL_STORE
#undef USE_XP_FROM_STEAM
...
#define ASW_MAX_PLAYERS 1			// currently limiting the game to 6 players, more than that feels chaotic
